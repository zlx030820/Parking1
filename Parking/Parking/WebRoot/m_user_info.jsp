		...
		<div class="shell">
			...
			<div id="navigation">
				<ul>
					...
					<li><a href="UserAction!userMessage.action?id=${user.id}" class="active"><span>个人资料</span> </a>
					</li>
			...
			<div id="main">
				...
				<div id="content">
					...
					<div class="box">
						<!-- Box Head -->
						<div class="box-head">
							<h2 class="left" style="text-align:center">用戶信息</h2>
						...
						<div class="table">
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tr style="text-align:center">
									<th style="text-align:center;font-size:14px">用户ID</th>
									<th style="text-align:center;font-size:14px">登录名</th>
									<th style="text-align:center;font-size:14px">密码</th>
									<th style="text-align:center;font-size:14px">余额</th>
								</tr>
								<tr>
