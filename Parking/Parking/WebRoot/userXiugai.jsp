...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/img/allbg.gif'>
			<form method="post" id=form1 action=${request.contextPath}/Parking/UserAction!updateUser.action?id=${session.userMessage.id} name="formPw">
			<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
				<tr bgcolor="#EEF4EA">
				    <td colspan="2" background="<%=path %>/img/wbg.gif" class='title'><span>用户信息修改</span></td>
				</tr>
				<tr bgcolor="#FFFFFF">
				    ...
				    <td width="75%" bgcolor="#FFFFFF">
				        <input type="text" value="${session.userMessage.username}" name="userName" size="20" disabled="disabled"/>
				    </td>
				</tr>
				<tr bgcolor="#FFFFFF">
				    <td width="25%" bgcolor="#FFFFFF" align="right">
