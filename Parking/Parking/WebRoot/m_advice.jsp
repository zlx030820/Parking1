...
<body>
	...
	<div id="header">
		<div class="shell">
			...
			<div id="navigation">
				<ul>
					<li><a href="ParkAction!ParkList.action"><span>停车场操作</span>
					</a></li>
					<li><a href="UserAction!userList1.action"><span>费用操作</span>
					</a></li>
					<li><a href="UserAction!userList.action"><span>用户管理</span>
					</a></li>
					<li><a href="UserAction!getAdvice.action" class="active"><span>评论管理</span>
					</a></li>
						...
						<div class="table">
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tr style="text-align:center">
									...
									<th style="text-align:center;font-size:14px">删除</th>
								</tr>
								<c:forEach items="${session.allAdvices}" var="bean"
									...
									<tr>
										...
										<td><a class="ico del" onClick="deleteAdvice('${bean.id}')"
											value="${bean.id}">删除</a></td>
									</tr>
								</c:forEach>
							</table>
						</div>
