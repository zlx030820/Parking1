		...
		<div class="shell">
			...
			<div id="navigation">
				<ul>
					...
					<li><a href="UserAction!userList.action" class="active"><span>用户管理</span> </a>
					</li>
			...
			<div id="main">
				...
				<div id="content">
					...
					<div class="box">
						<!-- Box Head -->
						<div class="box-head">
							<h2 class="left" style="text-align:center">用户信息</h2>
						...
						<div class="table">
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tr style="text-align:center">
									...
									<th style="text-align:center;font-size:14px">是否为管理员</th>
								...
								<c:forEach items="${userList}" var="bean" varStatus="i">
									<tr>
										...
										<td>${bean.administra}</td>
										<td>${bean.balance}</td>
										<td><a class="ico del" onClick="deleteUser('${bean.id}')"
											value="${bean.id}">删除</a>
										</td>
									</tr>
								</c:forEach>
